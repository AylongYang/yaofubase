...
public class JSONUtils {
     ...
     *       <li>if {@link JSONObject#getLong(String)} exception, return defaultValue
     *       <li>return {@link JSONObject#getLong(String)}
     *     </ul>
     */
     ...
     *       <li>if jsonObject is null, return defaultValue
     *       <li>if key is null or empty, return defaultValue
     *       <li>if {@link JSONObject#getInt(String)} exception, return defaultValue
     *       <li>return {@link JSONObject#getInt(String)}
     *     </ul>
     */
     ...
     *       <li>if jsonObject is null, return defaultValue
     *       <li>if key is null or empty, return defaultValue
     *       <li>if {@link JSONObject#getDouble(String)} exception, return defaultValue
     *       <li>return {@link JSONObject#getDouble(String)}
     *     </ul>
     */
     ...
     *       <li>if jsonObject is null, return defaultValue
     *       <li>if key is null or empty, return defaultValue
     *       <li>if {@link JSONObject#getString(String)} exception, return defaultValue
     *       <li>return {@link JSONObject#getString(String)}
     *     </ul>
     */
     ...
     *     </ul>
     */
    public static String getStringCascade(
            JSONObject jsonObject, String defaultValue, String... keyArray) {
        if (jsonObject == null) {
            return defaultValue;
        }
     ...
     *       <li>if jsonObject is null, return defaultValue
     *       <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue
     *       <li>return {@link JSONUtils#getStringList(JSONObject, String, List)}
     *     </ul>
     */
     ...
     *       <li>if jsonObject is null, return defaultValue
     *       <li>if key is null or empty, return defaultValue
     *       <li>if {@link JSONObject#getJSONObject(String)} exception, return defaultValue
     *       <li>return {@link JSONObject#getJSONObject(String)}
     *     </ul>
     */
    public static JSONObject getJSONObject(
            JSONObject jsonObject, String key, JSONObject defaultValue) {
        if (jsonObject == null || StringUtils.isEmpty(key)) {
            return defaultValue;
        }
     ...
     *       <li>if jsonData is null, return defaultValue
     *       <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue
     *       <li>return {@link JSONUtils#getJSONObject(JSONObject, String, JSONObject)}
     *     </ul>
     */
    ...
    public static JSONObject getJSONObjectCascade(
            JSONObject jsonObject, JSONObject defaultValue, String... keyArray) {
        if (jsonObject == null) {
            return defaultValue;
        }
     ...
     *       <li>if key is null or empty, return defaultValue
     *       <li>if {@link JSONObject#getJSONArray(String)} exception, return defaultValue
     *       <li>return {@link JSONObject#getJSONArray(String)}
     *     </ul>
     */
     ...
     *       <li>if jsonObject is null, return defaultValue
     *       <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue
     *       <li>return {@link JSONUtils#getBoolean(JSONObject, String, Boolean)}
     *     </ul>
     */
     ...
     * @param key
     * @return <ul>
     *       <li>if jsonObject is null, return null
     *       <li>return {@link JSONUtils#parseKeyAndValueToMap(String)}
     *     </ul>
     */
     ...
     * @param key
     * @return <ul>
     *       <li>if jsonData is null, return null
     *       <li>if jsonData length is 0, return empty map
     *       <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return null
     *       <li>return {@link JSONUtils#getMap(JSONObject, String)}
     *     </ul>
     */
     ...
     * @return <ul>
     *       <li>if sourceObj is null, return null
     *       <li>else parse entry by {@link MapUtils#putMapNotEmptyKey(Map, String, String)} one by
     *           one
     *     </ul>
     */
